...
arma::vec cpp_opt_edge_lengths(const arma::mat& ppwts_2d, const arma::mat& ppinv, const arma::vec& f3_est, Function qpsolve, const arma::vec& lower, const arma::vec& upper, double fudge, bool constrained);
RcppExport SEXP _admixtools_cpp_opt_edge_lengths(SEXP ppwts_2dSEXP, SEXP ppinvSEXP, SEXP f3_estSEXP, SEXP qpsolveSEXP, SEXP lowerSEXP, SEXP upperSEXP, SEXP fudgeSEXP, SEXP constrainedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< double >::type fudge(fudgeSEXP);
    Rcpp::traits::input_parameter< bool >::type constrained(constrainedSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_opt_edge_lengths(ppwts_2d, ppinv, f3_est, qpsolve, lower, upper, fudge, constrained));
    return rcpp_result_gen;
END_RCPP
}
// cpp_fill_pwts
...
// cpp_packedancestrymap_ploidy
NumericVector cpp_packedancestrymap_ploidy(String genofile, int nsnp, int nind, IntegerVector indvec, int ntest);
RcppExport SEXP _admixtools_cpp_packedancestrymap_ploidy(SEXP genofileSEXP, SEXP nsnpSEXP, SEXP nindSEXP, SEXP indvecSEXP, SEXP ntestSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< String >::type genofile(genofileSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(cpp_packedancestrymap_ploidy(genofile, nsnp, nind, indvec, ntest));
    return rcpp_result_gen;
END_RCPP
}
...
// cpp_plink_ploidy
NumericVector cpp_plink_ploidy(String genofile, int nsnp, int nind, IntegerVector indvec, int ntest);
RcppExport SEXP _admixtools_cpp_plink_ploidy(SEXP genofileSEXP, SEXP nsnpSEXP, SEXP nindSEXP, SEXP indvecSEXP, SEXP ntestSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< String >::type genofile(genofileSEXP);
    ...
    Rcpp::traits::input_parameter< IntegerVector >::type indvec(indvecSEXP);
    Rcpp::traits::input_parameter< int >::type ntest(ntestSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_plink_ploidy(genofile, nsnp, nind, indvec, ntest));
    return rcpp_result_gen;
END_RCPP
}
// cpp_plink_to_afs
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_admixtools_cpp_opt_edge_lengths", (DL_FUNC) &_admixtools_cpp_opt_edge_lengths, 8},
